 ...
 *   Problem: each model mutation needs to know how to rebuild entire model.
 */
public final class Step2 {
  ...
  private static Graphic hungryClickableCheckbox(Model model) {
    ...
    return new Actionable<Model>(checkboxGraphic)
        .withMousePressHandler((Coordinate _, MouseButton _) -> new Model(!model.hungry(), model.tired()))
        .asGraphic();
  }
