...
public final class Scales {
  ...
  public static final Scale C_MAJOR = new Scale(C4, MAJOR);

  public static final Scale A_MAJOR = new Scale(A4, MAJOR);

  public static final Sequence<Integer> MINOR = Sequences.of(0, 2, 3, 5, 7, 8, 10);

  public static final Scale C_MINOR = new Scale(C4, MINOR);

  public static final Scale A_MINOR = new Scale(A4, MINOR);

  public static final Sequence<Integer> MAJOR_PENTATONIC = Sequences.of(0, 2, 4, 7, 9);

  public static final Scale C_MAJOR_PENTATONIC = new Scale(C4, MAJOR_PENTATONIC);
