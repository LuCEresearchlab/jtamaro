 ...
 * 
 * The origin of the CartesianWorld, the position (0, 0),
 ...
 * and to include axes, rendered as a horizontal and vertical line intersecting at the origin, in a given color.
 */
public class CartesianWorld {
   ...
   * @param graphic the graphic to place (the graphic will be placed such that its pinning position will coincide with the given x and y)
