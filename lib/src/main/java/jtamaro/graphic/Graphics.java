...
//  /**
//   * Creates a graphic that wraps another graphic and has an action that can be executed in an
//   * interaction when the user presses a mouse button and the cursor is hovering over the (rendered)
//   * given graphic.
//   *
//   * <p>This is only use in interactions to handle click events of specific graphics.
//   */
//  public static <T> Graphic pressable(
//      MousePressAction<T> action,
//      Graphic graphic
//  ) {
//    return new ActionableGraphic<>(action, graphic);
//  }
//
//  /**
//   * Creates a graphic that wraps another graphic and has an action that can be executed in an
//   * interaction when the user releases a mouse button and the cursor is hovering over the
//   * (rendered) given graphic.
//   *
//   * <p>This is only use in interactions to handle click events of specific graphics.
//   */
//  public static <T> Graphic releasable(
//      MouseReleaseAction<T> action,
//      Graphic graphic
//  ) {
//    return new ActionableGraphic<>(action, graphic);
//  }
...
//  /**
//   * Creates a graphic that wraps another graphic and has an action that can be executed in an
//   * interaction when the user drags the mouse over the (rendered) given graphic.
//   *
//   * <p>This is only use in interactions to handle click events of specific graphics.
//   */
//  public static <T> Graphic draggable(
//      MouseDragAction<T> action,
//      Graphic graphic
//  ) {
//    return new ActionableGraphic<>(action, graphic);
//  }
...
//  /**
//   * Creates a graphic that wraps another graphic and has an action that can be executed in an
//   * interaction when the user moves the mouse over the (rendered) given graphic.
//   *
//   * <p>This is only use in interactions to handle click events of specific graphics.
//   */
//  public static <T> Graphic movable(
