 ...
 * structures (with types like {@code Sequence}, {@code Option}, and {@code Pair}), and
 * functionality for developing purely-functional interactive applications (with a fluent API to
